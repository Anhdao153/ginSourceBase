...
const (
	HealthCheck_HealthCheck_FullMethodName = "/healthCheck.HealthCheck/HealthCheck"
)
...
func (c *healthCheckClient) HealthCheck(ctx context.Context, in *HealthCheckReq, opts ...grpc.CallOption) (*HealthCheckReply, error) {
...
func (UnimplementedHealthCheckServer) HealthCheck(context.Context, *HealthCheckReq) (*HealthCheckReply, error) {
...
func _HealthCheck_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthCheckServer).HealthCheck(ctx, req.(*HealthCheckReq))
	}
...
var HealthCheck_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "rpc/healthCheck/healthCheck.proto",
}
